...
define fastcc void @ping_recurse(i32* nocapture %mx, i32* nocapture %mr, i32 %color, i32* %A) unnamed_addr {
entry:
  tail call fastcc void @ping_recurse(i32* nonnull %mx, i32* nonnull %mr, i32 %color, i32* %A)
