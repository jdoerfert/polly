...
; IR-NEXT:  %tmp4_p_scalar_ = load i64, i64* %p_arrayidx3
=======
; IR-NEXT:  %pollytmp = ptrtoint i64* %scevgep to i64
; IR-NEXT:  %scevgep14 = getelementptr i64, i64* %scevgep13, i64 %pollytmp
; IR-NEXT:  %tmp4_p_scalar_ = load i64, i64* %scevgep14
>>>>>>> Allow "no-return" function calls.
; IR-NEXT:  %p_add4 = add nsw i64 %tmp4_p_scalar_, %polly.preload.tmp3.merge
; IR-NEXT:  store i64 %p_add4, i64* %scevgep14
;
...
=======
; IR-NEXT:  %scevgep = getelementptr i64, i64* %ptr, i64 1
; IR-NEXT:  %scevgep13 = getelementptr i64, i64* %A, i64 1
>>>>>>> Allow "no-return" function calls.
;
;
