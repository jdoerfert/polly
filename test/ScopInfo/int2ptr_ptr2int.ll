...
; IR-NEXT:  %pollytmp1 = inttoptr i64 %10 to i64*
; IR-NEXT:  %scevgep = getelementptr i64, i64* %pollytmp1, i64 1
; IR-NEXT:  %pollytmp2 = ptrtoint i64* %scevgep to i64
; IR-NEXT:  %scevgep1 = getelementptr i64, i64* %A, i64 %pollytmp2
; IR-NEXT:  %tmp3_p_scalar_ = load i64, i64* %scevgep1, !alias.scope !0, !noalias !2
; IR-NEXT:  %pollytmp = ptrtoint i64* %scevgep2 to i64
; IR-NEXT:  %scevgep4 = getelementptr i64, i64* %scevgep3, i64 %pollytmp
; IR-NEXT:  %tmp4_p_scalar_ = load i64, i64* %scevgep4, !alias.scope !0, !noalias !2
; IR-NEXT:  %p_add4 = add nsw i64 %tmp4_p_scalar_, %tmp3_p_scalar_
; IR-NEXT:  store i64 %p_add4, i64* %scevgep4, !alias.scope !0, !noalias !2
...
=======
; IR-NEXT:  %10 = add i64 %val, 1
; IR-NEXT:  %scevgep2 = getelementptr i64, i64* %ptr, i64 1
; IR-NEXT:  %scevgep3 = getelementptr i64, i64* %A, i64 1
