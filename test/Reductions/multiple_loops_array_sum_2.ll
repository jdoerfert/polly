...
for.inc:                                          ; preds = %for.inner, %for.body
  %indvars.iv1 = phi i64 [ 0, %for.body ], [ %1, %for.inner ]
  ...
  br i1 %exitcond1, label %for.inc5, label %for.inner

for.inner:                                        ; preds = %for.inc
  %indvars.ivK = phi i64 [ 0, %for.inc ], [ %incK, %for.inner ]
  %incK = add nuw nsw i64 %indvars.ivK, 1
  %exitcond3 = icmp eq i64 %incK, 100
  br i1 %exitcond3, label %for.inc, label %for.inner
