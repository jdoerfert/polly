...
struct GroupNodeCompare {
  bool compare(DefNodeGroup *DNG0, DefNodeGroup *DNG1) const;
  bool operator()(DefNodeGroup *DNG0, DefNodeGroup *DNG1) const {
...
public:
  ...
  bool propagateEdges(DefNodeGroup &DNG, unsigned *MaxStreams = nullptr);
private:
